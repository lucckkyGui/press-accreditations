...
const CommandPalette: React.FC = () => {
  ...
  const items = useMemo<PaletteItem[]>(() => {
    const nav: PaletteItem[] = [
      ...
      { id: "n-guests",     label: "Goście",            path: "/guests",           icon: Users,           keywords: "guests lista osób",     kind: "navigation", shortcut: "G G" },
      { id: "n-scanner",    label: "Skaner QR",          path: "/scanner",          icon: QrCode,          keywords: "scanner check-in",     kind: "navigation", shortcut: "G S" },
      { id: "n-tickets",    label: "Bilety",            path: "/ticketing",        icon: Ticket,          keywords: "tickets sprzedaż",     kind: "navigation" },
    ...
    const action: PaletteItem[] = [
      ...
      { id: "a-import",     label: "Importuj gości z CSV",    path: "/guests?import=1", icon: Upload, kind: "action", shortcut: "I" },
